...
def calculate_task_score(task):
    ...
    if days_left < 0:
        ...
        score += 60
        explanation.append("Due soon (<=3 days).")
    elif days_left <= 7:
        score += 30
    ...
    if hours <= 2:
        score += 15;
        explanation.append("Quick win bonus.")
    elif hours > 8:
        score -= 10
        explanation.append("High effort penalty.")

    if task.get("dependencies"):
        score += 20
        explanation.append("Has dependencies (blocks others).")
